...
export default function ProductDetail() {
  ...
  // ✅ Recién acá haces returns condicionales (ya se ejecutaron TODOS los hooks)
  if (isLoading) {
    return (
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div className="animate-fade-in">
            <div className="relative aspect-square bg-secondary rounded-xl flex items-center justify-center overflow-hidden">
              ...
              <span
                className={`badge-stock absolute top-4 right-4 ${
                  stockStatus === "available"
          ...
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: "100ms" }}>
            ...
            <h1 className="text-2xl md:text-3xl font-bold leading-tight">{product.nombre}</h1>

            <p className="text-muted-foreground">
              Compatible con:{" "}
              <span className="text-foreground font-medium">{product.modelo_compatible}</span>{" "}
            ...
            <div className="bg-secondary/50 rounded-xl p-6">
              <div className="flex items-baseline gap-3">
                ...
                {product.iva_incluido && <Badge variant="secondary">IVA incluido</Badge>}
              </div>
              <p className="text-sm text-muted-foreground mt-2">Precio por {product.unidad_medida}</p>
            </div>
            ...
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>
                  <strong>{product.stock_actual}</strong> {product.unidad_medida}(s) disponible(s)
                </span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button size="lg" variant="outline" onClick={() => handleDemoAction("Solicitar cotización")}>
            ...
            <div className="bg-success/5 border border-success/20 rounded-xl p-4">
              ...
              <p className="text-sm text-muted-foreground">Despacho en 24-48 horas hábiles (Demo)</p>
            </div>
